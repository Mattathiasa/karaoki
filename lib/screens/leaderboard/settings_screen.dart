                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        KMicStatus(connected: true, level: 0.7),
                      ],
                    ),
                  ),
                  const SizedBox(height: 24),
                  // Settings rows
                  _SettingsRow(icon: Icons.high_quality, label: 'Audio quality', value: 'High \u00b7 256kbps'),
                  _SettingsRow(icon: Icons.notifications, label: 'Turn notifications', value: 'On', trailing: _LimeSwitch()),
                  _SettingsRow(icon: Icons.dark_mode, label: 'Appearance', value: 'Dark'),
                  _SettingsRow(icon: Icons.shield, label: 'Privacy', value: 'Friends only'),
                  _SettingsRow(icon: Icons.email, label: 'Account', value: 'matt@email.com'),
                  _SettingsRow(icon: Icons.help, label: 'Help & feedback', value: ''),
...
class _SettingsRow extends StatelessWidget {
  ...
  const _SettingsRow({required this.icon, required this.label, required this.value, this.trailing});
